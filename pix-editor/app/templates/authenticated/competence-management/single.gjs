...
<template><div class="main-left competence-management">
  ...
  <div class="competence-management__details">
    <div class="competence-management__data">
      <form action class="ui form">
        <Input data-test-competence-title-input @value={{@controller.competence.title}} @edition={{@controller.edition}} @label="Titre" @id="competence-title-fr" />
        <Textarea @title="Description :" @value={{@controller.competence.description}} @edition={{@controller.edition}} @id="competence-description-fr" />
        <div class="ui raised segment">
          <i class="flag gb uk"></i>
          <Input @value={{@controller.competence.titleEn}} @edition={{@controller.edition}} @label="Titre (en)" @id="competence-title-en" />
          <Textarea @title="Description (en) :" @value={{@controller.competence.descriptionEn}} @edition={{@controller.edition}} @id="competence-description-en" />
        </div>
    ...
    <div class="ui vertical compact labeled icon menu competence-management__menu">
      ...
      {{#if @controller.edition}}
        <button data-test-save-button class="ui button item important-action" {{on "click" @controller.save}} type="button">
          <i class="save icon"></i>
          Enregistrer
        </button>
