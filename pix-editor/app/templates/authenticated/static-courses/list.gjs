  ...
  <header class="page-header">
    ...
    <div class="page-actions">
      <PixTooltip
        ...
        @hide={{@controller.model.mayCreateStaticCourse}}
      >
        <:triggerElement>
          <PixButtonLink
            @backgroundColor="blue"
            @route="authenticated.static-courses.new"
            @isDisabled={{not @controller.model.mayCreateStaticCourse}}
    ...
    <section class="page-section">
      ...
      >
        <PixInput
          ...
          {{on "keyup" @controller.updateName}}
          ...
          <tbody>
            {{#each @controller.model.staticCourseSummaries as |staticCourseSummary|}}
              <tr class="tr--clickable">
                ...
                <td
                  {{on "click" (fn @controller.goToStaticCourseDetails staticCourseSummary.id)}}
                >{{staticCourseSummary.challengeCount}}</td>
                <td {{on "click" (fn @controller.goToStaticCourseDetails staticCourseSummary.id)}}>{{formatDate
                    staticCourseSummary.createdAt
                    "DD/MM/YYYY"
                    allow-empty=true
                  }}</td>
                <td {{on "click" (fn @controller.goToStaticCourseDetails staticCourseSummary.id)}}>
                ...
                <td class="actions">
                  ...
                  >
                    <:triggerElement>
                      <PixIconButton
                        @triggerAction={{fn @controller.copyStaticCoursePreviewUrl staticCourseSummary}}
                        @iconName="copy"
                        @iconPrefix="far"
