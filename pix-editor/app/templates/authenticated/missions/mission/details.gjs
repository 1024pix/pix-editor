...
<template><header class="page-header">
  ...
  <div class="page-actions">
    <PixButtonLink @route="authenticated.missions.mission.edit" @isDisabled={{not @controller.model.userMayCreateOrEditMissions}} class="pix-button-link-with-icon white-font">
    ...
    <Card class="mission-details__card-information" @title="1. Informations">
      <ul>
        ...
        <li>
          ...
          <a href={{@controller.model.mission.introductionMediaUrl}} target="_blank">{{@controller.model.mission.introductionMediaUrl}}</a>
        </li>
        <li>
        ...
        <li>
          ...
          <a href={{@controller.model.mission.documentationUrl}} target="_blank">{{@controller.model.mission.documentationUrl}} </a>
        </li>
        <li><span class="bold">Crée le : </span>{{formatDate @controller.model.mission.createdAt "DD/MM/YYYY" allow-empty=true}}</li>
      </ul>
    </Card>
  </section>
