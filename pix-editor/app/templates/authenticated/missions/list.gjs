...
<template><header class="page-header">
  ...
  {{#if @controller.model.mayCreateOrEditMissions}}
    <div class="page-actions">
      <PixButtonLink @backgroundColor="blue" @route="authenticated.missions.new" class="pix-button-link-with-icon white-font">
...
<main class="page-body">
  <section class="page-section">
    <PixFilterBanner @title="Filtres" class="table-filter-banner" @clearFiltersLabel="Réinitialiser les filtres" @onClearFilters={{@controller.clearFilters}} @isClearFilterButtonDisabled={{false}}>
      <PixMultiSelect id="mission-status-multi-select" @screenReaderOnly={{true}} @placeholder="Aucun" @onChange={{@controller.onChangesStatus}} @values={{@controller.getStatusSelected}} @emptyMessage="Il n'y a pas de statut" @options={{@controller.statusesOption}}>
        <:label>Statut</:label>
