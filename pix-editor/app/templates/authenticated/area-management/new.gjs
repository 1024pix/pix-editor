...
<template><div class="main-left area-management">
  ...
  <div class="area-management__details">
    <div class="area-management__data">
      <form action class="ui form">
        <Input data-test-area-title-input @value={{@controller.area.titleFrFr}} @edition={{true}} @label="Titre" @id="area-title-fr" />
