...
<template><div class="main-title  {{if this.config.lite "lite" ""}}">
  <h1 class="ui header">
    <div class="ui right floated menu">
      <LinkTo @route="authenticated.competence.prototypes.single" @model={{@challenge}} class="ui button icon item"><i class="icon window close"></i></LinkTo>
    </div>
    Déclinaisons de {{@challenge.skillName}}
  </h1>
</div>
