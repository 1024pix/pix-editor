        ...
        <div class="challenge-view-header-first">
          <p>
            {{#if @challengeLocale.isPrototype}}
              Proto
            {{else}}
              Déclinaison {{@challengeLocale.alternativeVersion}}
            {{/if}}
        ...
        <div class="challenge-view-header-second">
          ...
          <div class="challenge-view-header-second__actions">
            ...
            {{#let (@challengeLocale.getTranslationsUrl @competence) as |translationsUrl|}}
              {{#if translationsUrl}}
                <a class="phrase-link" href={{translationsUrl}} target="_blank" rel="noopener noreferrer" aria-label={{concat "traduction de l'épreuve de version " @challengeLocale.alternativeVersion}}>
