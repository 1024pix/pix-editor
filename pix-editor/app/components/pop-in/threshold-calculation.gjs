...
<template><PixModal @title={{@title}} @onCloseButtonClick={{this.closeModal}} @showModal={{@showModal}}>
  <:content>
  ...
  <:footer>
    <PixButton data-test-sorting-pop-in-deny @backgroundColor="transparent-light" @isBorderVisible={{true}} @triggerAction={{this.closeModal}}>
      Fermer
    </PixButton>
  </:footer>
</PixModal></template>
