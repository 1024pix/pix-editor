...
<template><PixModal @title={{this.title}} @onCloseButtonClick={{this.closeModal}} @showModal={{@showModal}} class="popin-tube-level">
  <:content>
    <div class="levels">
  ...
  <:footer>
    <PixButton data-test-cancel-button @backgroundColor="transparent-light" @isBorderVisible={{true}} @triggerAction={{this.closeModal}}>
      {{t "common.cancel"}}
    </PixButton>
    {{#if this.mayUnset}}
