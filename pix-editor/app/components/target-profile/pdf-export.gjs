...
<template><button class="ui button" {{on "click" this.exportPdf}} type="button">
  <i class="pdf file icon"></i>PDF
</button>
<PdfEntries @validateAction={{this.generatePDF}} @close={{this.closeTitleInput}} @showModal={{this.displayTitleInput}} />
</template>
