...
import VuePixTableColumn from './pix-table-column.dist.js';
...
export default class PixTableColumn extends Component {
  ...
  mountVue(element) {
    this.vueApp = createApp({
      render: () => h(VuePixTableColumn, this.propsData),
    });
  ...
  <template>
    <div
      ...
      {{didUpdate (fn this.updateProps "context") @context}}
      {{didUpdate (fn this.updateProps "type") @type}}
      {{didUpdate (fn this.updateProps "sortOrder") @sortOrder}}
      {{didUpdate (fn this.updateProps "ariaLabelDefaultSort") @ariaLabelDefaultSort}}
      {{didUpdate (fn this.updateProps "ariaLabelSortDesc") @ariaLabelSortDesc}}
      {{didUpdate (fn this.updateProps "ariaLabelSortAsc") @ariaLabelSortAsc}}
      {{didUpdate (fn this.updateProps "isMainRow") @isMainRow}}
    ></div>
  </template>
}
