...
module('Unit | Model | localized-challenge', function(hooks) {
  ...
  module('#statusCSS', function() {
    [
      ...
      { challengeStatus: 'archivé', localizedChallengeStatus: 'proposé', expectedStatus: 'suggested' },
  ...
  module('#statusText', function() {
    [
      ...
      { challengeStatus: 'archivé', localizedChallengeStatus: 'proposé', expectedText: 'Pas en prod' },
  ...
  module('#isInProduction', function() {
    [
      ...
      { challengeStatus: 'archivé', localizedChallengeStatus: 'proposé', expected: false },
