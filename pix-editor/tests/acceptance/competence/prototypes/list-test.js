...
module('Acceptance | competence/prototypes/list', function() {
  module('visiting /competence/:competence_id/prototypes/list/:tube_id/:skill_id', function(hooks) {
    ...
    hooks.beforeEach(async function() {
      ...
      this.server.create('challenge', { id: 'recChallenge1', airtableId: 'airtableRecChallenge1', instruction: 'instructionsChallenge1', notes: [this.server.create('note')] });
      this.server.create('challenge', { id: challengeId2, airtableId: 'airtableRecChallenge2', instruction: 'instructionsChallenge2', notes: [this.server.create('note')] });
      this.server.create('challenge', { id: 'recChallenge3', airtableId: 'airtableRecChallenge3', notes: [] });
