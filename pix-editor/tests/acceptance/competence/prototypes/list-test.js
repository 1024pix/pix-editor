  ...
  module('visiting /competence/:competence_id/prototypes/list/:tube_id/:skill_id', function (hooks) {
    ...
    hooks.beforeEach(async function () {
      ...
      this.server.create('challenge', {
        id: 'recChallenge1',
        airtableId: 'airtableRecChallenge1',
        instruction: 'instructionsChallenge1',
        notes: [this.server.create('note')],
      });
      this.server.create('challenge', {
        id: challengeId2,
        airtableId: 'airtableRecChallenge2',
        instruction: 'instructionsChallenge2',
        notes: [this.server.create('note')],
      });
      ...
      this.server.create('skill', {
        ...
        name: skillName,
        version: 3,
        createdAt: '2020-12-11T13:38:35.000Z',
        challengeIds: ['recChallenge1'],
      });
      this.server.create('skill', {
        id: deadSkillId,
        pixId: deadSkillPixId,
        name: skillName,
        version: 1,
        status: 'périmé',
        challengeIds: [],
      ...
      this.server.create('tube', {
        id: tubeId1,
        rawSkillIds: [skillId1, skillId2, deadSkillId],
      });
