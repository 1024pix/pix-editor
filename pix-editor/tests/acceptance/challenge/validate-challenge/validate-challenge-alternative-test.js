...
module('Acceptance | Validate Alternative Challenge', function (hooks) {
  ...
  hooks.beforeEach(function () {
    ...
    proposedAlternative1 = this.server.create('challenge', {
      id: 'recChallenge3',
      status: 'proposé',
      genealogy: 'Décliné 1',
      version: 1,
      instruction: 'Déclinaison',
    });

    proposedPrototype = this.server.create('challenge', {
      id: 'recChallenge2',
      status: 'proposé',
      genealogy: 'Prototype 1',
      version: 1,
    });
    proposedAlternative2 = this.server.create('challenge', {
      id: 'recChallenge4',
      status: 'proposé',
      genealogy: 'Décliné 1',
      version: 1,
    ...
    this.server.create('skill', {
      id: 'recSkill1',
      status: 'actif',
      challengeIds: ['recChallenge1', 'recChallenge3'],
      version: 1,
    });
    this.server.create('skill', {
      id: 'recSkill2',
      status: 'suggested',
      challengeIds: ['recChallenge2', 'recChallenge4'],
      version: 2,
    });
