...
module('Acceptance | Static Courses', function(hooks) {
  ...
  module('static course details', function(hooks) {
    ...
    test('should access to static course details', async function(assert) {
      ...
      assert.strictEqual(removeWhitespacesFnc(indexCellB.textContent), '0');
      ...
      assert.strictEqual(removeWhitespacesFnc(indexCellA.textContent), '1');
      ...
      assert.strictEqual(removeWhitespacesFnc(indexCellC.textContent), '2');
