...
import { LocalizedChallengeRepository } from '../../../../../lib/infrastructure/repositories/propal/index.js';

describe('Integration | Repository | LocalizedChallengeRepository', function() {
  let localizedChallengeRepository;
  beforeEach(function() {
    localizedChallengeRepository = new LocalizedChallengeRepository();
  });
