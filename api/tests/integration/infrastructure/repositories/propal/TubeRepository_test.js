...
import { TubeRepository } from '../../../../../lib/infrastructure/repositories/propal/index.js';

describe('Integration | Repository | TubeRepository', () => {
  let tubeRepository;
  beforeEach(function() {
    tubeRepository = new TubeRepository();
  });
