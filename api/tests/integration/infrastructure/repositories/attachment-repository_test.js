...
describe('Integration | Repository | attachment-repository', () => {
  ...
  describe('#createBatch', () => {
    ...
    it('should persist models in DB', async () => {
      // given
      const attachmentA = domainBuilder.buildAttachment({
        id: null,
        url: 'url/to/clone/attachmentA',
      ...
      // when
      await attachmentRepository.createBatch([attachmentA, attachmentB]);
      ...
      expect(attachmentsDB).toMatchObject([
        {
          id: 'airtableIdAttachmentA',
          airtableId: 'airtableIdAttachmentA',
          filename: 'attachmentA_filename',
          url: 'url/to/clone/attachmentA',
          type: 'illustration',
          size: 123,
        ...
        {
          id: 'airtableIdAttachmentB',
          airtableId: 'airtableIdAttachmentB',
          filename: 'attachmentB_filename',
          url: 'url/to/clone/attachmentB',
          type: 'attachment',
          size: 456,
  ...
  describe('#create', () => {
    ...
    it('should persist the attachment in DB', async () => {
      // given
      const attachment = domainBuilder.buildAttachment({
        id: null,
        url: 'url/to/attachment',
      ...
      // then
      const attachmentDB = await knex('attachments').select('*').where({ id: 'airtableIdAttachment' }).first();
      expect(attachmentDB).toMatchObject(
        {
          id: 'airtableIdAttachment',
          airtableId: 'airtableIdAttachment',
          filename: 'attachment_filename',
          url: 'url/to/attachment',
          type: 'illustration',
          size: 123,
