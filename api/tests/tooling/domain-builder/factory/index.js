module.exports = {
  ...
  buildChallengeCollectionForEditor: require('./build-challenge-collection-for-editor'),
  buildChallengeForEditor: require('./build-challenge-for-editor'),
  ...
  buildSkillForEditor: require('./build-skill-for-editor'),
  ...
  buildTubeForEditor: require('./build-tube-for-editor'),
