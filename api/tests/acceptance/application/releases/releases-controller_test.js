...
function mockCurrentContent() {
  const expectedCurrentContent = {
    ...
    tubes: [{
      ...
      practicalTitleFrFr: 'Titre pratique du Sujet - fr',
      practicalTitleEnUs: 'Titre pratique du Sujet - en',
      practicalDescriptionFrFr: 'Description pratique du Sujet - fr',
      practicalDescriptionEnUs: 'Description pratique du Sujet - en',
