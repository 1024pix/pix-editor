...
import { audioElementSchema } from '../../../../../lib/application/modules/validation/element/audio-schema.js';
import { customDraftElementSchema } from '../../../../../lib/application/modules/validation/element/custom-draft-element-schema.js';
import { customElementSchema } from '../../../../../lib/application/modules/validation/element/custom-element-schema.js';
import { downloadElementSchema } from '../../../../../lib/application/modules/validation/element/download-schema.js';
import { embedElementSchema } from '../../../../../lib/application/modules/validation/element/embed-schema.js';
import { flashcardsElementSchema } from '../../../../../lib/application/modules/validation/element/flashcards-schema.js';
import { imageElementSchema } from '../../../../../lib/application/modules/validation/element/image-schema.js';
import { qabElementSchema } from '../../../../../lib/application/modules/validation/element/qab-schema.js';
import { qcmDeclarativeElementSchema } from '../../../../../lib/application/modules/validation/element/qcm-declarative-schema.js';
import { qcmElementSchema } from '../../../../../lib/application/modules/validation/element/qcm-schema.js';
import { qcuDiscoveryElementSchema } from '../../../../../lib/application/modules/validation/element/qcu-discovery-schema.js';
import { qcuElementSchema } from '../../../../../lib/application/modules/validation/element/qcu-schema.js';
import {
  blockInputSchema,
  blockSelectSchema,
  qrocmElementSchema,
} from '../../../../../lib/application/modules/validation/element/qrocm-schema.js';
import { separatorElementSchema } from '../../../../../lib/application/modules/validation/element/separator-schema.js';
import { shortVideoElementSchema } from '../../../../../lib/application/modules/validation/element/short-video-schema.js';
import { textElementSchema } from '../../../../../lib/application/modules/validation/element/text-schema.js';
import { videoElementSchema } from '../../../../../lib/application/modules/validation/element/video-schema.js';
import {
          ...
          cards: [
            {
              id: randomUUID(),
              recto: {
                image: { url: 'https://example.org/image.jpeg' },
    ...
    it('should validate sample qcm declarative structure', async function() {
      try {
        const sample = {
          ...
          feedback: { diagnosis: '<p>Un exemple de diagnostic...</p>' },
          hasShortProposals: false,
        };
  ...
  describe('grain cross-fields business rules', function() {
    function _createStepperComponent() {
      return {
        ...
        steps: [{ elements: [{ id: randomUUID(), type: 'text', tag: ' ', content: '<p>Étape 1</p>' }] }, { elements: [{ id: randomUUID(), type: 'text', tag: ' ', content: '<p>Étape 2</p>' }] }],
      };
    }
