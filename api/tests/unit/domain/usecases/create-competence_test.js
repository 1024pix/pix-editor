...
describe('Unit | Domain | Usecases | create competence', function() {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(tubeTransformer, 'forRelease');
  ...
  describe('when area has some competences', () => {
    it('should compute new competence index accordingly', async () =>{
      ...
      tubeTransformer.forRelease.mockReturnValueOnce(transformedTube);
      ...
      expect(tubeTransformer.forRelease).toHaveBeenCalledWith(createdTube, createdThematic, []);
