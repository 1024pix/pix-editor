...
import {
  ...
  extractFromChallengeLimitedToSize,
  prefixFor,
} from '../../../../lib/infrastructure/translations/challenge.js';
...
describe('Unit | Infrastructure | Challenge translations', () => {
  ...
  describe('#extractFromChallengeLimitedToSize', () => {
    it('should filter translations exceeding size limit from challenge', () => {
      const challengeId = 'test';
      const challenge = new Challenge({
        id: challengeId,
        translations: {
          fr: {
            instruction: 'consigne en français qui dépasse le nombre maximum de caractères dans un champ',
            alternativeInstruction: 'consigne alternative en français',
            proposals: 'propositions en français',
            solution: 'bonnes réponses en français',
            solutionToDisplay: 'bonnes réponses à afficher en français',
      ...
      const translations = extractFromChallengeLimitedToSize(70)(challenge);
      expect(translations).to.deep.equal([
        {
          key: `challenge.${challengeId}.alternativeInstruction`,
          locale: 'fr',
