...
describe('Unit | Repository | CompetenceRepository', () => {
  ...
  describe('#getMany', () => {
    it('should return the list of all competences having given ids with translations', async () => {
      ...
      vi.spyOn(competenceRepository.translationRepository, 'listByEntities')
      ...
      expect(competenceRepository.translationRepository.listByEntities).toHaveBeenCalledWith('competence', ['competence1', 'competence2']);
