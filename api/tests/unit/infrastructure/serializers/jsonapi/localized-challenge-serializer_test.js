  ...
  describe('#deserialize', () => {
    it('should deserialize a Localized Challenge', async () => {
      ...
      const expectedLocalizedChallenge = domainBuilder.buildLocalizedChallenge({
        geography: 'BZ',
        urlsToConsult: ['url-to-consult.org', 'url-to-consult.com'],
      });
      const json = {
        data: {
          ...
          attributes: {
            ...
            geography: 'Bélize',
            'urls-to-consult': 'url-to-consult.org, url-to-consult.com',
      ...
      const json = {
        data: {
          ...
          attributes: {
            ...
            locale: expectedLocalizedChallenge.locale,
            status: expectedLocalizedChallenge.status,
            'urls-to-consult': expectedLocalizedChallenge.urlsToConsult.join(', '),
          },
          relationships: {
            challenge: {
              data: {
      ...
      const expectedSerializedLocalizedChallenge = {
        data: {
          ...
          attributes: {
            ...
            'embed-url': null,
            geography: 'Belize',
            'urls-to-consult': 'https://urls.fr, pouet.fr',
